...
public interface IChessPiece {
    ...
    * would be redundant).  Therefore, the {@code [move.fromRow,
    *  move.fromColumn]} component of {@code move} is necessary.
    ...
    * move to be made.
    * @param board the {@link W13project3.IChessBoard} in which this 
    * piece resides.
    ...
    * @throws IllegalArgumentException  if {@code this} object isn't the
    *  piece at location {@code [move.fromRow, move.fromColumn]}.
    ****************************************************************/
